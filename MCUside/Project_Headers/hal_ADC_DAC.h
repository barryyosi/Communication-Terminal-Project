#ifndef BSP_ADC_DAC_H_
#define BSP_ADC_DAC_H_
...
uint8_t   CLM1;
uint8_t   CLM0;
} tADC_Calibration_Blk ;


// function prototypes:

uint8_t ADC_Calibration(ADC_MemMapPtr);

void ADC_Config_Alt(ADC_MemMapPtr, tADC_ConfigPtr);

void ADC_Read_Cal(ADC_MemMapPtr, tADC_Calibration_Blk *);
